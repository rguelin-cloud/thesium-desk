...
def _build_proposed_changes_section(conn: sqlite3.Connection) -> str:
    ...
    # [JUSTIFICATION_MEMO_V1] ajoute colonne justification au tableau
    orders = conn.execute(
