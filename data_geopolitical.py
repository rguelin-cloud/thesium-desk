...
"""
# [GDELT_FIX_V4] applied 2026-05-25 19:02:55 - 1:session-close,2:catch-connection-error,3:min-delay-10-20-30

# [GDELT_FIX_V3] applied 2026-05-25 18:58:40 - A:429-timestamp-update,B:min_delay-8/16/24,C:timeout-timestamp-update

# [GDELT_TIMEOUT_FIX_V2] applied 2026-05-25 18:53:38
...
# === [GDELT_MODULE_DISABLED_V1] BEGIN ===
...
_GDELT_DISABLED = _os_gdelt.environ.get("NEXTONES_GDELT_DISABLED", "1") not in ("0", "false", "False", "")
# === [GDELT_MODULE_DISABLED_V1] END ===
...
# [GEO_BUILD_LOCK_V1] serialise les appels concurrents au build complet
...
def _query_gdelt(query: str, mode: str = "artlist", maxrecords: int = 75,
    ...
    for attempt in range(max_retries):
        ...
        with _gdelt_lock:
            ...
            min_delay = 10.0 + (attempt * 10.0)  # [GDELT_FIX_V4] 10/20/30s entre essais  # [GDELT_FIX_V3] 8s/16s/24s entre essais
...
def _build_geopolitical_result() -> dict:
    """[GEO_BUILD_LOCK_V2] Wrapper qui serialise les builds concurrents via _build_lock.
...
def fetch_geopolitical_risk() -> dict:
    """Main entry point. [GEO_BUILD_LOCK_V1]
    Returns the full geopolitical risk dashboard.
    Serialise les builds concurrents via _build_lock.
    """
    # === [GDELT_MODULE_DISABLED_V1] guard BEGIN ===
    if _GDELT_DISABLED:
        # GDELT/USGS desactives volontairement.
        return {
            "disabled": True,
            "reason": "GDELT/USGS module disabled ([GDELT_MODULE_DISABLED_V1])",
            "global_score": None,
            "regime": None,
            "theaters": [],
            "chokepoints": [],
    ...
    # === [GDELT_MODULE_DISABLED_V1] guard END ===
...
def start_background_fetch():
    ...
    if _GDELT_DISABLED:
        ...
        print("[GEO] start_background_fetch() : DISABLED (toggle _GDELT_DISABLED=True)")
        return
    # === [GDELT_MODULE_DISABLED_V1] guard END ===
