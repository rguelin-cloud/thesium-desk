...
def _compute_regime_overlay(
    ...
    def _classify(vol_pct, dd_pct, vix_proxy, asset_class, dd_long_pct=None):
        if asset_class == 'crypto':
            vol_stress, vol_calm = 45.0, 15.0  # [PATCH_BACKTEST_ENGINE_CRYPTO_THRESHOLDS_V2]
            dd_stress, dd_calm = -8.0, -3.0
            dd_long_stress, dd_long_calm = -15.0, -3.0
        else:
            vol_stress, vol_calm = 25.0, 15.0  # [PATCH_BACKTEST_ENGINE_EQUITY_REVERT_V4]
        ...
        if asset_class != 'crypto' and vix_proxy is not None:
            ...
            elif vix_proxy <= 15.0: n_calm += 1  # [PATCH_BACKTEST_ENGINE_EQUITY_REVERT_V4]
