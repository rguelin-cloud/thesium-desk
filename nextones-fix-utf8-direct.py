# -*- coding: utf-8 -*-
"""
Fix UTF-8 double-encoding (mojibake) sur le projet ThesiumDesk.
APPEL DIRECT en Python — pas de helper temp pour éviter le bug encoding PowerShell.

Usage : py -3.13 .\nextones-fix-utf8-direct.py
"""
import sys
...
# Signatures mojibake — fortes, sans ambiguïté
SIGNATURES = [
    "\u00c3\u00a9",  # Ã©  (é mojibake)
    "\u00c3\u00a8",  # Ã¨
    "\u00c3\u00a0",  # Ã 
