...
# === [FRED_IS_PAST_DATETIME_V1] BEGIN ===
...
def _get_economic_calendar():
    ...
    RELEASE_MAP = {
        ...
        # === [FRED_GDP_SERIES_V1] : series=A191RL1Q225SBEA (Real GDP % chg SAAR), fmt=raw_pct ===
        53:  {"event": "GDP (Estimate)",                 "impact": "high",   "time": "08:30 ET", "category": "growth",  # [FRED_GDP_LABEL_V1]
