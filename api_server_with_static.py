...
def get_regime_current():
    ...
    try:
        ...
        _resp["error"] = str(_e)
    return _resp
# Fin [PATCH_API_REGIME_CURRENT_V1]  --------------------------------------------------------------
